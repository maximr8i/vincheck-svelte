...
<section class="advantage__wrapper">
  <div class="container">
    <div class="advantage">
      <div class="image">
        <img src={bmw} alt="BMW" />
      ...
      <div class="description">
        ...
        <ul class="list">
          <li>
            ...
            <div class="text">
              <p>{items[0].firstText}</p>
              <p>{items[0].secondText}</p>
            </div>
          </li>
          <li>
            <div class="icon">
            ...
            <div class="text">
              <p>{items[1].firstText}</p>
              <p>{items[1].secondText}</p>
            </div>
          </li>
          <li>
            <div class="icon">
            ...
            <div class="text">
              <p>{items[2].firstText}</p>
              <p>{items[2].secondText}</p>
            </div>
          </li>
          <li>
            <div class="icon">
            ...
            <div class="text">
              <p>{items[3].firstText}</p>
              <p>{items[3].secondText}</p>
            </div>
          </li>
        </ul>
      </div>
